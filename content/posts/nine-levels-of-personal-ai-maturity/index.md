...
## Complementary infographics

Full-resolution PNGs for the figures in this post live in the repository ; open a link below if you want a sharper copy :

1. **Personal AI maturity model** : [high resolution on GitHub](https://github.com/bilarikan/bilarikan.github.io/blob/main/content/posts/nine-levels-of-personal-ai-maturity/SCR-20260503-HQ1.png).
2. **The Cliff between using and building** : [high resolution on GitHub](https://github.com/bilarikan/bilarikan.github.io/blob/main/content/posts/nine-levels-of-personal-ai-maturity/SCR-20260503-HQ2.png).
3. **The plateau at before the Cliff** : [high resolution on GitHub](https://github.com/bilarikan/bilarikan.github.io/blob/main/content/posts/nine-levels-of-personal-ai-maturity/SCR-20260503-HQ3.png).
4. **Match the learning format to the level** : [high resolution on GitHub](https://github.com/bilarikan/bilarikan.github.io/blob/main/content/posts/nine-levels-of-personal-ai-maturity/SCR-20260503-HQ4.png).
5. **Not everyone wants to tinker** : [high resolution on GitHub](https://github.com/bilarikan/bilarikan.github.io/blob/main/content/posts/nine-levels-of-personal-ai-maturity/SCR-20260503-HQ5.png).
