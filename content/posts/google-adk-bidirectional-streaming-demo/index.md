...
The code is available on [this branch of the GitHub repository](https://github.com/bilarikan/live-streaming-agent-with-google-adk/tree/standard-adk-bidi-demo-mic-plus-camera), with some files omitted for standard security practice (e.g. `.env` and everything in `.venv/`).
